...
# Define the generator with Sigmoid activation to ensure outputs are in [0, 1]
def build_generator():
...
# Compare variances and min values
original_min = np.min(data, axis=0)
generated_min = np.min(generated_data_denormalized, axis=0)
print("Original Min:", original_min)
print("Generated Min:", generated_min)
